    ...
    <div class="row">
        ...
        <h1 class="title">CREATE JOB AD</h1>
            <sf:form method="POST" modelAttribute="ad" action="/new_ad" enctype="multipart/form-data">
                    ...
                    <div class="input">
                        <sf:input path="msg" class="ad_text" type="text" placeholder="Write your notification which will be displayed to accepted applicants"/>
                    </div>

                    <div class="imgbutton">
                        <sf:label for="image" path="image" style="cursor: pointer;" class="label">Upload ad image
                            <div class="output">
                                <img path="output" id="output" class="ad_img">
                            </div>
                        </sf:label>
                    </div>
